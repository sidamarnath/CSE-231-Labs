...
for line in infile:
    ...
    print("{:<12s} {:<12.2f} {:<12.2f} {:<12.2f}".format(row[0], height, weight, BMI))
    
# prints average, max, and min values for the number of rows in the file  
print("{:<12s} {:<12.2f} {:<12.2f} {:<12.2f}".format("Average", total_height/row_count, total_weight/row_count, total_BMI/row_count)) 
print("{:<12s} {:<12.2f} {:<12.2f} {:<12.2f}".format("Max", maximum_height, maximum_weight, maximum_BMI))
print("{:<12s} {:<12.2f} {:<12.2f} {:<12.2f}".format("Min", minimum_height, minimum_weight, minimum_BMI)) 
